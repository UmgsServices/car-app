interface propt{
    View:any
    getInput(item:any,$key:String):any
    HandleView(item:any):void
}

function Drivers({View,getInput,HandleView}:propt){
   
  return<>{ View.map((item:any)=> <table rules="none" border={1} style={{width:"110%",margin:"50px auto"}} key={item.id}>
         <tr>
