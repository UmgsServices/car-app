...
function Feeds( {loginData,setPage}:props){
...
function DeleteReply(item:any,reply:any){
...
function DeleteFeed(item:any){
    requestApi(`${url}/${item.id}`,"DELETE")
    console.log(item.name)
}
function chaneStatus(item:any){
